...
export declare class AddNodeCommand implements Command {
    ...
    private title;
    private position;
    constructor(nodeId: NodeID, parentId: NodeID | null, title: string, position?: {
        x: number;
        y: number;
    });
...
export declare class MoveNodeCommand implements Command {
    ...
    constructor(nodeId: NodeID, newPosition: {
        x: number;
        y: number;
    });
    execute(state: MindMap): MindMap;
...
export declare class AddTagCommand implements Command {
    private nodeId;
    private tag;
    private wasAdded;
    constructor(nodeId: NodeID, tag: string);
    execute(state: MindMap): MindMap;
    undo(state: MindMap): MindMap;
    get description(): string;
    get timestamp(): number;
}
export declare class RemoveTagCommand implements Command {
    private nodeId;
    private tag;
    private wasRemoved;
    constructor(nodeId: NodeID, tag: string);
