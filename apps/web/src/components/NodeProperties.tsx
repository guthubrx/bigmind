...
import {
  getNodePropertiesTabs,
  onNodePropertiesRegistryChange,
} from '../utils/nodePropertiesRegistry';
    ...
    <div className="node-properties-container">
      ...
      <div className="properties-tabs">
        ...
        {pluginTabs.map(tab => {
          const Icon = tab.icon;
          const badgeCount =
            tab.badge && selectedNodeId ? tab.badge(selectedNodeId, selectedNode) : null;
          ...
          <div className="content-tab">
            <div className="form-group">
              <input
                ...
                onChange={e =>
                  selectedNodeId && updateActiveFileNode(selectedNodeId, { title: e.target.value })
                }
              />
            </div>
            ...
            <div className="form-group form-group-flex">
              <MarkdownEditor
                ...
                onChange={value =>
                  selectedNodeId && updateActiveFileNode(selectedNodeId, { notes: value })
                }
