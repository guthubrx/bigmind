...
const COLOR_PALETTES_COLLECTION: ColorPalette[] = [
  ...
  // 7 Palettes essentielles
  {
    ...
    colors: [
      '#93c5fd', '#c4b5fd', '#f9a8d4', '#fca5a5', '#fdba74',
...

  {
    ...
    colors: [
      '#92400e', '#78350f', '#854d0e', '#713f12', '#365314',
      '#14532d', '#064e3b', '#134e4a', '#1e3a8a', '#1e40af',
    ],
  },

  {
    ...
    colors: [
      '#22d3ee', '#a78bfa', '#f472b6', '#fb923c', '#facc15',
...

  {
    ...
    colors: [
      '#0c4a6e', '#075985', '#0369a1', '#0891b2', '#0d9488',
      '#059669', '#047857', '#065f46', '#134e4a', '#164e63',
    ],
  },
  ...
  // 33 Palettes étendues
  {
    ...
    colors: [
      '#7c2d12', '#991b1b', '#9a3412', '#c2410c', '#d97706',
      '#ca8a04', '#a16207', '#854d0e', '#78350f', '#713f12',
    ],
  },

  {
    ...
    colors: [
      ...
      '#4ade80', '#86efac', '#bbf7d0', '#84cc16', '#65a30d',
    ],
  },

  {
    ...
    colors: [
      ...
      '#f472b6', '#a21caf', '#c026d3', '#d946ef', '#e879f9',
    ],
  },

  {
    ...
    colors: [
      '#7c2d12', '#9a3412', '#c2410c', '#ea580c', '#dc2626',
      '#b91c1c', '#92400e', '#78350f', '#854d0e', '#a16207',
    ],
  },

  {
    ...
    colors: [
      '#fef3c7', '#fde68a', '#fcd34d', '#bbf7d0', '#86efac',
      '#4ade80', '#f9a8d4', '#f472b6', '#c4b5fd', '#a78bfa',
    ],
  },
...

  {
    ...
    colors: [
      ...
      '#e5e9f0', '#eceff4', '#8fbcbb', '#88c0d0', '#5e81ac',
    ],
  },

  {
    ...
    colors: [
      '#ff6b6b', '#ee5a6f', '#f06595', '#ff8787', '#ffa94d',
      '#ffd43b', '#fab005', '#fd7e14', '#ff922b', '#fa5252',
    ],
  },

  {
    ...
    colors: [
      '#339af0', '#4dabf7', '#74c0fc', '#22b8cf', '#15aabf',
      '#12b886', '#20c997', '#51cf66', '#94d82d', '#a9e34b',
    ],
  },

  {
    ...
    colors: [
      ...
      '#0984e3', '#a29bfe', '#fab1a0', '#ff7675', '#ffeaa7',
    ],
  },

  {
    ...
    colors: [
      '#d4a574', '#c19a6b', '#8b7355', '#a0826d', '#b4846c',
      '#c9a882', '#9c7a66', '#8b6f47', '#704214', '#8b4513',
    ],
  },

  {
    ...
    colors: [
      '#1e3a8a', '#1e40af', '#1d4ed8', '#3b82f6', '#0f766e',
      '#047857', '#dc2626', '#d97706', '#4b5563', '#1f2937',
    ],
  },

  {
    ...
    colors: [
      '#fbbf24', '#fb923c', '#f472b6', '#c084fc', '#a78bfa',
      '#60a5fa', '#38bdf8', '#2dd4bf', '#34d399', '#fde047',
    ],
  },
...

  {
    ...
    colors: [
      ...
      '#81a1c1', '#5e81ac', '#b48ead', '#8fbcbb', '#4c566a',
    ],
  },

  {
    ...
    colors: [
      ...
      '#e64553', '#fe640b', '#df8e1d', '#40a02b', '#1e66f5',
    ],
  },

  {
    ...
    colors: [
      ...
      '#268bd2', '#6c71c4', '#d33682', '#073642', '#002b36',
    ],
  },

  {
    ...
    colors: [
      ...
      '#7aa2f7', '#7dcfff', '#bb9af7', '#c0caf5', '#1a1b26',
    ],
  },

  {
    ...
    colors: [
      ...
      '#61afef', '#c678dd', '#be5046', '#abb2bf', '#282c34',
    ],
  },

  {
    ...
    colors: [
      '#ff00ff', '#00ffff', '#ff2975', '#f222ff', '#8c1eff',
      '#ff901f', '#ffd319', '#9400d3', '#ff4500', '#ffd700',
    ],
  },

  {
    ...
    colors: [
      '#00ff9f', '#00b8ff', '#ff00ff', '#ff5c8a', '#bd00ff',
      '#d600ff', '#ffd700', '#ff4500', '#00ffff', '#070f34',
    ],
  },

  {
    ...
    colors: [
      ...
      '#ff6c11', '#ff10f0', '#00e0ff', '#ff90e8', '#fdff6a',
    ],
  },

  {
    ...
    colors: [
      '#c681cc', '#cc6933', '#d3be47', '#a9d33e', '#508fba',
      '#e86f68', '#83b799', '#c2b28f', '#fb2e01', '#6fcb9f',
    ],
  },

  {
    ...
    colors: [
      '#722880', '#d72d51', '#eb5c18', '#f08800', '#deb600',
      '#a68b5b', '#8b7d6b', '#7c6a4f', '#c19a6b', '#556b2f',
    ],
  },

  {
    ...
    colors: [
      '#2cceff', '#f80cd5', '#8ce411', '#f7e11c', '#f52909',
      '#ff6ec7', '#00ffcc', '#ffff00', '#ff00ff', '#00ff00',
    ],
  },

  {
    ...
    colors: [
      '#ff0090', '#ff4500', '#ff8c00', '#ffd700', '#fc0fc0',
      '#2de2e6', '#f000ff', '#ff6ec7', '#00ffff', '#ffff00',
    ],
  },

  {
    ...
    colors: [
      '#cc241d', '#d79921', '#98971a', '#458588', '#b16286',
      '#d65d0e', '#689d6a', '#fe8019', '#fb4934', '#fabd2f',
    ],
  },

  {
    ...
    colors: [
      ...
      '#c4a7e7', '#e0def4', '#6e6a86', '#908caa', '#191724',
    ],
  },

  {
    ...
    colors: [
      '#f85149', '#fb8500', '#d29922', '#3fb950', '#1f6feb',
      '#a371f7', '#bc4c00', '#58a6ff', '#8957e5', '#0d1117',
    ],
  },

  {
    ...
    colors: [
      ...
      '#ae81ff', '#f8f8f2', '#75715e', '#49483e', '#272822',
    ],
  },

  {
    ...
    colors: [
      '#e95678', '#fab795', '#fac29a', '#09f7a0', '#25b0bc',
      '#59e3e3', '#6c6f93', '#b877db', '#f09483', '#21bfc2',
    ],
  },

  {
    ...
    colors: [
      '#f07178', '#ffaa33', '#ffee99', '#b8cc52', '#95e6cb',
      '#59c2ff', '#d4bfff', '#f29e74', '#39bae6', '#0a0e14',
    ],
  },
];
...
export const manifest: PluginManifest = {
  ...
  version: '1.0.0',
  description: '41 palettes de couleurs complètes pour tous les besoins',
  author: {
    name: 'BigMind Team',
  ...
  icon: '🎨',
  category: 'theme',
  tags: ['colors', 'palettes', 'theme', 'essential', 'extended'],
  license: 'MIT',
