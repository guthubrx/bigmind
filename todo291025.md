...
## 🆕 MISE À JOUR 29 OCT 2025 - Décisions Marketplace
...
**Option retenue : GitHub + Services publics (sans serveur dédié)**
...
- [ ] Créer `apps/web/src/services/GitHubPluginRegistry.ts`
...
**PHASE 3 : Interface Unifiée (2 jours)**
- [ ] Modifier `PluginManager.tsx` pour afficher builtin + remote
- [ ] Ajouter badges : `[CORE]` `[OFFICIAL]` `[COMMUNITY]` `[ACTIF]` `[DISPONIBLE]`
- [ ] Intégrer fonctions installation de `RemotePluginMarketplace`
- [ ] Ajouter stats dans les cards : downloads, rating
- [ ] Filtres : statut + source
...
- [ ] Mettre à jour manifests CORE avec `autoActivate: true`
- [ ] Tests
...
- [ ] Créer discussion par plugin
- [ ] Intégrer Giscus widget dans `PluginDetailModal`
- [ ] Afficher rating moyen dans cards

**TOTAL : ~8 jours de développement**
